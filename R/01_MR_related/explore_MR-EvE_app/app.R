                ...
                tabsetPanel(type = "tabs",
                            ...
                            tabPanel("Info", 
                                     ...
                                     p(style="text-align: left; padding-left: 6cm; padding-right: 6cm; padding-top: 1cm; padding-bottom: 2cm",
                                       ...
                                       "This Shiny app shows a visualisation of MR-EvE (Mendelian Randomization “Everything-vs-Everything”) 
                                       ...
                                       br(),br(), 
                                       "The circles represe#nt MR ‘best estimate’ effect direction (green – reduces risk, pink - increases 
                                       ...
                                       (epigraphdb.org) (Liu et al 2020). The MR estimates were generated by the MR Mixture-of-Experts 
                                       (MR-MoE) method (Hemani et al 2017). ",
                                       br(), br(),
