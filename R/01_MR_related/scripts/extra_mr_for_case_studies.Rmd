...
if (all){ res_df_all <- mr_exp_local(exp_snps = tophits, out_id = 'ieu-a-1126') }
if (pos){ res_df_pos <- mr_exp_local(exp_snps = tophits, out_id = 'ieu-a-1127') }
if (neg){ res_df_neg <- mr_exp_local(exp_snps = tophits, out_id = 'ieu-a-1128') }
...
if (step2_mr[step2_mr$outcome == "Breast cancer ",]$effect_direction != 'overlaps null') {all =T} else{all =F}
if (step2_mr[step2_mr$outcome == "ER+ Breast cancer ",]$effect_direction != 'overlaps null') {pos =T} else{pos =F}
if (step2_mr[step2_mr$outcome == "ER- Breast cancer ",]$effect_direction != 'overlaps null') {neg =T} else{neg =F}
...
pt2 <- step2_mr %>% 
  filter(effect_direction != 'overlaps null') %>% 
  select(exposure,  outcome, "total_OR_CI" = OR_CI, "total_ED" = effect_direction, nsnp)
  

X <- bind_rows(pt1, pt2) %>%  arrange(outcome)
