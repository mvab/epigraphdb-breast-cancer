...
traits_df<-read_tsv("mr_evidence_outputs/trait_for_followup.tsv")
...
all.files <- list.files(path = paste0("mr_evidence_outputs/mr_subtypes/"), pattern = paste0("^sens*"), full.names = T)
l <- lapply(all.files, read_tsv, show_col_types = FALSE)
all_res<- bind_rows(l)
...
write_tsv(all_res, paste0("mr_evidence_outputs/mr_subtypes/all_traits_sensMR_vs_BCAC2020.tsv"))
```
