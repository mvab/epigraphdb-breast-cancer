...
trait_df_all <- read_tsv("../../01_MR_related/results/mr_evidence_outputs/trait_manual_ivw_subtypes_mergedV3.tsv") %>% 
  ...
  select(id.exposure, exposure, exposure_cat) %>% distinct() # 130


# traits with the same name or trait that ar eunlike to match to something meaningful
ignore_traits<- c("ieu-a-974", "ieu-a-89", "ieu-a-49","ieu-a-99", "ieu-a-50", "ieu-a-101", "ieu-a-68", "ieu-a-62", "ieu-a-75", "ieu-a-107", "prot-a-1541", "ieu-a-302")
...
trait_df_all %>% count(lit_analysis) # True 116
...
write_tsv(counts_by_cat_df, "../results/literature_outputs/available_litspace_counts_by_exposure_catV3.tsv")
```
...
related_traits <- list(
  ...
  bmi = c("ieu-a-835"),
  obesity = c(	'ieu-a-93',	'ieu-a-91',	'ieu-a-90',	'ieu-a-85', "ieu-a-85"),
  waist_hip = c('ieu-a-60','ieu-a-72','ieu-a-55'),
  #fruit = c('ukb-b-3881','ukb-b-16576','ukb-b-2221'),
  menopause = c('ukb-a-316' , 'ukb-b-17422'),
  hrt = c('ukb-b-4564', 'ukb-b-18541'),
  #birth = c('ukb-a-320', 'ukb-b-1209'),
  vldl_particles = c("met-c-927" ,"met-c-889", "met-c-886" ,"met-c-950" ,"met-c-912", "met-c-887", "met-c-909", "met-c-913"),
  hdl_particles = c( "ukb-d-30760_irnt" ,"met-c-864" , "met-c-923" , "met-c-945"  )
...
trait_df_comb$exposure_cat <- c("Anthropometric","Anthropometric","Anthropometric","Anthropometric", "Reproductive","Reproductive",  "Lipids","Lipids")
...
write_tsv(lit_counts, "../results/literature_outputs/lit_space_statsV3.tsv")
...
writexl::write_xlsx(all_tidy_spaces, "../results/literature_outputs/all_tidy_spacesV3.xlsx")
...
library(cowplot)
lid_data<- read_tsv(  "../results/literature_outputs/lit_space_statsV3.tsv")
...
protein_path_data <- read_tsv("../../external_files/pathwaysV3/proteins_w_pathwaysV3.tsv") 
