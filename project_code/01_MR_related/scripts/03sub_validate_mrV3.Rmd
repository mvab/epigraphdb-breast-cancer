...
length(unique(redoneMR_tidy$id.exposure)) # 102 validated
...
for (i in 104:length(ids)){ # NBb skipped 57 prot-a-2356 and 103 prot-b-55, - no harmonized with wny outcome: 
    trait = ids[i]
